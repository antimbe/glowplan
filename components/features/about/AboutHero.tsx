        ...
        <Stack space={12} align="center" className="text-center max-w-4xl mx-auto">
          ...
          >
            <Flex align="center" gap={2} className="px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white mb-6 mx-auto w-fit">
              ...
              <Text variant="small" as="span" className="font-bold tracking-widest uppercase text-[10px] md:text-xs">Notre Histoire</Text>
            </Flex>
          </MotionBox>
          ...
          <Stack space={6}>
            ...
            >
              <Heading level={1} variant="hero" className="text-white text-balance">
                Redéfinir l'excellence dans l'univers de la <Box as="span" className="text-accent italic font-serif">beauté</Box>.
              </Heading>
            </MotionBox>
          </Stack>
        </Stack>
