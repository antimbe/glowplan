    ...
    return (
        <div className="flex flex-col h-full">
            <div className="flex-1 overflow-y-auto relative">
                ...
                <div
                    className="grid border-b border-gray-100 bg-gray-50/50 sticky top-0 z-30"
                    style={{ gridTemplateColumns: `${AGENDA_CONFIG.TIME_COLUMN_WIDTH_PX}px 1fr` }}
                >
                    <div className="h-14 bg-gray-50/50" />
                    <div className="h-14 flex items-center justify-center font-semibold text-gray-700 border-l border-gray-100 bg-gray-50/50">
                        {isToday(currentDate) && (
                ...
                {/* Grid content with TimeIndicator offset if needed */}
