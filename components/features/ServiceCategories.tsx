...
import { Container, Section, Button, Link, Heading, Text, Box, Flex, MotionBox, Stack } from "@/components/ui";
        ...
        <Box className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 md:gap-12">
          {categories.map((category, index) => {
            return (
              ...
              >
                <Flex direction="col" align="center" gap={5} className="group cursor-pointer">
